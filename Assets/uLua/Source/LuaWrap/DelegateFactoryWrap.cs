...
public class DelegateFactoryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("UICamera_GetAnyKeyFunc", UICamera_GetAnyKeyFunc),
			new LuaMethod("UICamera_OnScreenResize", UICamera_OnScreenResize),
			new LuaMethod("UICamera_OnCustomInput", UICamera_OnCustomInput),
			new LuaMethod("UICamera_OnSchemeChange", UICamera_OnSchemeChange),
	...
	static int UICamera_GetAnyKeyFunc(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		LuaFunction arg0 = LuaScriptMgr.GetLuaFunction(L, 1);
		Delegate o = DelegateFactory.UICamera_GetAnyKeyFunc(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int UICamera_OnSchemeChange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		LuaFunction arg0 = LuaScriptMgr.GetLuaFunction(L, 1);
		Delegate o = DelegateFactory.UICamera_OnSchemeChange(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
