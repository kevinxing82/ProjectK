...
public static class DelegateFactory
{
	...
	public static void Register(IntPtr L)
	{
		...
		dict.Add(typeof(UICamera.GetAnyKeyFunc), new DelegateValue(UICamera_GetAnyKeyFunc));
		...
		dict.Add(typeof(UICamera.OnSchemeChange), new DelegateValue(UICamera_OnSchemeChange));
